...
class IteratorVector {
private:
    const TemplateVector<Element>& v;
    int poz = 0;
public:
    IteratorVector(const TemplateVector<Element>& v) noexcept;
    IteratorVector(const TemplateVector<Element>& v, int poz)noexcept;
    bool valid()const;
...
template<typename Element>
IteratorVector<Element>::IteratorVector(const TemplateVector<Element>& v) noexcept:v{ v } {}

template<typename Element>
IteratorVector<Element>::IteratorVector(const TemplateVector<Element>& v, int poz)noexcept : v{ v }, poz{ poz } {}
...
template<typename Element>
void IteratorVector<Element>::next() {
    poz++;
}
...
template<typename Element>
IteratorVector<Element> TemplateVector<Element>::begin()
{
    return IteratorVector<Element>(*this);
}

template<typename Element>
IteratorVector<Element> TemplateVector<Element>::end()
{
